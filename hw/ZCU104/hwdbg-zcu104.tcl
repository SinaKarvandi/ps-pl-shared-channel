...
#
# Generated by Vivado on Tue Mar 19 18:06:45 +0900 2024
...
set orig_proj_dir "[file normalize "$origin_dir/HyperDbg/hwdbg/hwdbg-zcu104"]"
...
if { [get_property IS_LOCKED [ get_files -norecurse block_design.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/HyperDbg/hwdbg/hwdbg-zcu104/hwdbg-zcu104.gen/sources_1/bd/block_design/hdl/block_design_wrapper.v" ]
} else {
