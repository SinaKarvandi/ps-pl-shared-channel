...
#
# hwdbg-zcu104.tcl: Tcl script for re-creating project 'hwdbg-zcu104'
#
# Generated by Vivado on Mon Apr 01 12:21:48 +0900 2024
...
#
# 1. This project restoration tcl script (hwdbg-zcu104.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "src/block_design_wrapper.v"
#    "src/top.v"
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "src/block_design_wrapper.v"]"\
 "[file normalize "src/top.v"]"\
 "[file normalize "src/blk_mem_gen_0.xci"]"\
 "[file normalize "src/constraints.xdc"]"\
 "[file normalize "src/top.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "hwdbg-zcu104"
...
set script_file "hwdbg-zcu104.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/hwdbg-zcu104"]"
...
set files [list \
 [file normalize "${origin_dir}/src/block_design_wrapper.v"]\
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/src/top.dcp" ]\
]
set imported_files ""
foreach f $files {
...
proc cr_bd_block_design { parentCell } {
  ...
  # Create ports
  set pl_ps_interrupt [ create_bd_port -dir I -type intr pl_ps_interrupt ]
  set_property -dict [ list \
   CONFIG.SENSITIVITY {EDGE_RISING} \
 ] $pl_ps_interrupt
  set ps_pl_gpio [ create_bd_port -dir O -from 3 -to 0 ps_pl_gpio ]
...
\
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_ports ps_pl_gpio]
  connect_bd_net -net pl_ps_interrupt_1 [get_bd_ports pl_ps_interrupt] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu7ev-ffvc1156-2-e -flow {Vivado Synthesis 2022} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs
} else {
...
set_property -name "incremental_checkpoint" -value "src/top.dcp" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu7ev-ffvc1156-2-e -flow {Vivado Implementation 2022} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs -parent_run synth_1
} else {
